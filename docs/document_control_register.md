...
| YL re-extraction of 11 September 2026 | `data/review/yanan_data_110926.csv` (original filename `Yanan Data 110926.csv`) | `d749768d47e4399319efda860de67cb364ee36452edac42018b41cff16f7195a` | Supplied file; compared, not adopted (A39); the pinned raw file `a167afc2…` is unchanged |
| YL meta-analysis exclusion table | `data/review/li_meta_analysis_exclusions_2026-09-11.xlsx` (original filename `22 excluded.xlsx`) | `1ffc996665c952fb7889a930e9dfa3e6c29e607ba60b198212a7f0a324fb304c` | 22 studies in HK's 45 not in YL's 23; mapped to the A33 worklist |
| EPHPP template sent by YL | `data/review/ephpp_tool_template_evans2015.pdf` (original filename `EPHPP Tool Questionnaire scoring.pdf`; not in Git) | `757f0b8b64d80f4b2aef7167760da9d77000986a4cbd61bf825f1a816ad0d36d` | Blank Evans et al. 2015 reproduction of the EPHPP tool and CASP checklist; Blinding component absent |
...
| Plan revision 1.6 | `../NEXT_VERSION_PLAN_v1.1.md` | `ef19cc5dec8bf13f1e360321399a58f7020c4408c0fc1038e20ca40de7610888` | 10 September 2026; revision 1.5 preserved at `../tmp/NEXT_VERSION_PLAN_v1.1.md_pre_rc1_backup_2026-09-10` (`7b045f179ae08cfc184f8e70e055d03c872e820cbead19f4d9784eedd9ce88d7`) |
| Handover for revision 1.6 | `../HANDOVER_2026-09-02.md` | `cd795c8ceb98bff2330de97441865e54c7d8d8bc197fb7294c25f212b7394222` | 10 September 2026 text; previous text preserved at `../tmp/HANDOVER_2026-09-02.md_pre_rc1_backup_2026-09-10` (`d40066e376331d6ed37bf69ecf37323c4a78b3693479d32d9f561dbb5edc850a`) |
| Plan revision 1.7 | `../NEXT_VERSION_PLAN_v1.1.md` | `846acb1981ea5376275c715ccfc7c9ecf00565432221c63b4189d18e0dea6370` | 12 September 2026 addendum (A39); revision 1.6 preserved at `../tmp/NEXT_VERSION_PLAN_v1.1.md_pre_rev1.7_backup_2026-09-12` |
| Handover for revision 1.7 | `../HANDOVER_2026-09-02.md` | `3bb19c3d9b35351fbeb8393b1a007f4284ca6f2998c0eaf2c9795474d74f2e8c` | 12 September 2026 text; 10 September text preserved at `../tmp/HANDOVER_2026-09-02.md_pre_2026-09-12_backup` |
| Student email drafts, 12 September 2026 | `../manuscript/emails_to_students_2026-09-10.md` | `96b6f841f8a947e194b367a672a0e4c157099e32950dab816aa798db17caa93c` | Rewritten after YL's 11 September reply; not sent; 10 September drafts preserved at `../tmp/emails_to_students_2026-09-10.md_pre_2026-09-12_backup` |
| Manuscript source, release candidate 1 (local, not in Git) | `../manuscript/manuscript.tex` | `5b9097fea11b0ec872b80aa52e7da61f238a7b3ba1b744f29a4f7fdb245cac81` | 10 September 2026; 6 September text preserved at `../tmp/manuscript.tex_pre_rc1_backup_2026-09-10` (`3f1d0e22bbdd7d3fe0ea415b53757ab9913379cfcdff8c890c18118789bd7f9d`) |
| Supplement source, release candidate 1 (local, not in Git) | `../manuscript/supplement.tex` | `2d1f90f1ba4ba8906bd6a5006618fc6579624a3a66e35601f08934785979cba6` | 10 September 2026; previous text at `../tmp/supplement.tex_pre_rc1_backup_2026-09-10` (`be86d98520262a614786e0a5869d69accbcaf4ffba0534670aadf4454df62b7a`) |
| Manuscript worklist, 10 September 2026 | `../manuscript/REVISION_WORKLIST_2026-09-10.md` | `c87398710f078e4d82a61848c09bc16ac2d3b7c9bb0fb1c0b4c7948e3f3a35e9` | Supersedes the 6 September worklist |
...
| 1 tested reproducible implementation | Passed | 10 September 2026 | Deterministic tests (57 tests, 151 expectations, none skipped), schema and ledger checks, fit registry with historical and release layers, cache-only mode with a tested failure path, run manifest and CI on `v1.1-dev`; `renv.lock` restored into a fresh library (102 packages, 0.76 minutes; `docs/gate1_2026-09-10/`); release-mode guards made into functions and each failure path tested (`tests/testthat/test-release-mode.R`) | `docs/gate1_2026-09-10/README.md` and `renv_restore_fresh_library.log`; `docs/fixtures/historical_outputs_2026-09-02.sha256` | CI covers the deterministic layer only (no Stan); the full environment is demonstrated on the development machine, and the cross-platform check is GT's independent rebuild (Gate 4); `bayesplot` remains a development build restored from `stan-dev.r-universe.dev` |
| 2 approved analysis specification | Passed 10 Sep 2026 on RT approval; AG and GT approval of A33 to A38 reported by RT the same day; written approval files and GT's documented challenge outstanding | 10 September 2026 | RT approved A24 as the strict comparison rule (A35), the A25 measurement rule with four corrections and ledger entries C15 to C29 (A36), A26 and A27 (A37), closed A32 (A38), and made the post hoc scope amendment A33 with the strict pool sizes (k = 0 prevalence, k = 1 trial) and the expected A33 pools (k = 6, k = 3) known | `docs/amendment_2026-09-06.md` entries A33 to A38 and its Section 3 approval record; `data/review/population_eligibility.csv`; `data/review/correction_ledger.csv`; `../manuscript/author_approval_request_2026-09-10.md` | Written approvals `docs/registration/approvals/A33_A38_AG_2026-09-10.pdf` and `A33_A38_GT_2026-09-10.pdf` with hashes; GT's documented challenge; PROSPERO version 3 submission by AG from `docs/registration/prospero_v3_draft_2026-09-10.md` |
| 3 auditable review record | Open: HK counts reported not derived; 17 records unscreened; A33 universe re-application pending retrieval (worklist); label collisions open; YL's 11 September 2026 re-extraction compared and not adopted, with three pool-relevant cells awaiting RT's decision (A39) | | HK's reply of 10 September 2026 supplies a complete flow (2,549 identified, 891 duplicates, 1,658 after deduplication, 1,641 screened, 1,569 excluded, 72 sought, 25 full-text exclusions, 45 included) but as reported figures, not derived from record-level decisions; screening was divided single screening, recorded as a deviation from the registered statement (A34) | `data/review/student_evidence_log.md` Section 4; `data/review/prisma_flow_comparison.csv`; `data/review/exclusion_table.docx`; amendment A34 | The 2,549 against 2,541 difference; identity and screening of the 17 records not screened in AIM Review; the mapping of 47 reports to 45 studies; the Rinaldi 2010, Van Duin 2021, Allott 2013 and Ramsay 2011 label collisions; EPHPP Blinding status and JBI items 6 and 7; YL's workbook with page sources and the 23-of-45 crosswalk; re-application of the A33 rule to Drake 2013, the 20 included but not extracted studies and the 17 unscreened records (`data/review/a33_universe_worklist.csv`) |
| 4 reproducible scientific run | Release candidate 1 run complete (10 Sep 2026, 13.3 minutes, 70 fits, none from cache, every gate passed); GT independent rebuild outstanding | 10 September 2026 | Full release fit of the extended registry under the A33 scope and the A36 release layer, with the A35 comparison analysis; outputs promoted; manuscript labelled pending PROSPERO version 3 and the archived approvals | Run manifest `output/run_manifest.json`, SHA-256 `d68c422d871710ff3c001ef18a0539bf4eaa0428c41983b83d7f54c486f310ba`; historical summaries byte-identical to `docs/fixtures/`; historical bridge Bayes factors 3.2 to 3.5 percent above quadrature under the local seed (A18 criterion not met, reported); `R/00b_release_inputs.R` outputs `data/derived/release_prevalence.csv` and `data/derived/release_trials.csv` | GT's independent rebuild of release candidate 1 from `renv.lock` in a clean environment against `docs/release_tolerances_2026-09-10.md` |
...
| Scope amendment A33 decided (added 10 September 2026) | 10 September 2026, with all original frequentist and Bayesian results visible and both pool sizes already computed and seen: k = 0 point-prevalence studies and k = 1 trial under the registered version 2.0 restriction, an expected k = 6 and k = 3 under A33 | `docs/amendment_2026-09-06.md` Section 1 and entries A33 and A35; decision record of RT, 10 September 2026 |
...
The final row is a later addition and does not concern the Bayesian specification of 1 September 2026. It is recorded here so that the review's one chronology table also carries the visibility position of the post hoc scope amendment. Chronology of 10 September 2026: RT verified both draft audits against the source PDFs and accepted every reading; approved A24 as the strict comparison rule, the A25 measurement rule with four corrections and release-layer ledger entries C15 to C29, A26 and A27, and closed A32; made the post hoc scope amendment A33, with AG's and GT's approval of A33 to A38 reported by RT the same day and the written approval files outstanding; recorded HK's reply of 10 September and the divided single screening as a registration deviation; and scheduled the release candidate 1 fit. Gate 2 passed on that basis, Gate 3 remains open and Gate 4 awaits GT's independent rebuild.
