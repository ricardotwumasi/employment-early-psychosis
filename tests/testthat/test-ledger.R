...
test_that("the correction ledger's projection reproduces the archived 2026-09-02 tribble exactly", {
  ...
  # Release-layer rows (C15 onwards, A36) are applied only by R/00b; the
  # historical projection must still equal the archived tribble exactly.
  ledger <- ledger[ledger$layer == "historical", ]
